...
<div class="outerContainer">
    ...
    <div class="detailContent searchCoditions" v-if='!isAction'>
        <!-- 查询条件 -->
        <p>
            <span>公民身份号码/社保卡号:</span>
            <a-input
                type="text"
                class="aInput"
                placeholder="请输入完整的公民身份号码/社保卡号"
                v-model="idCardNum"
    ...
    data() {
        return {
            ...
            notInnerData:[
                ...
                { label:"出生年月", val:void 0 ,name:'a0107'},
                ...
                { label:"居住地址", val:void 0 ,name:'a3711'},
            ...
            innerData:[
                ...
                { label:"手机号码", val:void 0 ,name:'a3707C'},
                ...
                { label:"现居住所在地", val:void 0 ,name:'a3711'},
                { label:"最高学历", val:void 0 ,name:'a0834'},
